...
import com.example.rickandmorty.domain.model.locationsFilters
...
@Composable
fun LocationsModalBottomSheetWithFilters(
    ...
    if (isSheetOpen.value) {
        ModalBottomSheet(
            ...
            Column(
                ...
                Button(
                    onClick = {
                        viewModel.getLocationsWithFilters()
